...
set title   "Quantidade FLOPS AVX para calcular residuo da Eliminação de Gauss"
set terminal qt 1 title "Quantidade FLOPS AVX para calcular residuo da Eliminação de Gauss"
