...
set title   "L3 Bandwidth para gerar SL"
set terminal qt 1 title "L3 Bandwidth para gerar SL"
set datafile separator ","
plot 'L3_GERA.dat' using 1:2 title "<com otimização>" lc rgb "green" with linespoints, \
