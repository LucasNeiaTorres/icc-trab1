...
set title   "L3 Bandwidth para resolver SL"
set terminal qt 1 title "L3 Bandwidth para resolver SL"
set datafile separator ","
plot 'L3_RESOLVE.dat' using 1:2 title "<com otimização>" lc rgb "green" with linespoints, \
